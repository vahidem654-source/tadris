...
const tmTabsHost = document.getElementById('tmTabsHost');
...
function enterTeachingMode(){
  ...
  // Move the floating panels + tabsbar + key topbar actions into the drawer
  tmMoveIn(document.getElementById('tabsbar'), tmTabsHost);
